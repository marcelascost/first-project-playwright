...
class CadastroLogin(BasePage):
    def __init__(self, page):
        ...
        self.input_email_registration = page.locator("form").filter(has_text="Signup").get_by_placeholder("Email Address").click()
        self.button_registration = page.get_by_role("button", name="Signup").click()
